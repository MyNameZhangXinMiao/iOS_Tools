 ...
 *  折线图
 */
@property (nonatomic, strong) XHChartLineView *chartLineView;
...
- (void)mapping {
    ...
    self.chartLineView = [[XHChartLineView alloc] initWithFrame:self.scrollView.bounds];
    ...
    self.chartLineView.type = self.type;
