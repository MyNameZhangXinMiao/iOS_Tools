...
#import "JJMsgSystemViewController.h"
...
@interface JJMsgSystemViewController ()
...
@implementation JJMsgSystemViewController
...
- (id<JXCategoryListContentViewDelegate>)listContainerView:(JXCategoryListContainerView *)listContainerView initListForIndex:(NSInteger)index {
    JJMsgDetailViewController *vc = [[JJMsgDetailViewController alloc] init];
    return vc;
}
