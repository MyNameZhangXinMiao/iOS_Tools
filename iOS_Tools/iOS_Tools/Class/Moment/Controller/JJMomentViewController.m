...
#import "JJZoomHeaderViewController.h"

@interface JJMomentViewController ()<UITableViewDataSource, UITableViewDelegate>
...
@implementation JJMomentViewController
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if ([str isEqualToString:@"头部缩放"]) {
        JJZoomHeaderViewController *vc = [[JJZoomHeaderViewController alloc] init];
