...
@interface JJClubViewController ()
<JXPagerViewDelegate,
...
@implementation JJClubViewController
...
- (id<JXPagerViewListViewDelegate>)pagerView:(JXPagerView *)pagerView initListAtIndex:(NSInteger)index {
    JJClubListViewController *list = [[JJClubListViewController alloc] init];
    if (index == 0) {
